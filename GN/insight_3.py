...
simfilename = "insight_3_sim.tsv"
labelfilename = "insight_3_label.csv"
sum_labels=0
...
f = open("pals-insight3-community.dat", 'w')
cur_com = 1
for c in communities:
...
export_edge_list(adjmat_in_community, labels=labels, filename='pals-insight3-edges.dat', delim=" ", header=False)
