...
simfilename = "insight_2_sim.tsv"
labelfilename = "insight_2_label.csv"
sum_labels=0
...
with open(labelfilename) as f:
    for line in f:
        ...
        Config.labels.append(label.split("__")[0]+'#'+label.split("__")[1])
...
f = open("pals-insight2-community.dat", 'w')
cur_com = 1
for c in communities:
...
export_edge_list(adjmat_in_community, labels=labels, filename='pals-insight2-edges.dat', delim=" ", header=False)
