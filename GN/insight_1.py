...
simfilename = "insight_1_sim.tsv"
labelfilename = "insight_1_label.csv"
sum_labels=0
...
f = open("pals-insight1-community.dat", 'w')
cur_com = 1
for c in communities:
...
export_edge_list(adjmat_in_community, labels=labels, filename='pals-insight1-edges.dat', delim=" ", header=False)
